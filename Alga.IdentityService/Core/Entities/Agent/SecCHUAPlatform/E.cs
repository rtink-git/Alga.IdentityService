...
namespace Alga.IdentityService.Core.Entities.Agent.SecCHUAPlatform;

public class E : Infrastructure.KVA.AdbABase<string?>, IE
{
    readonly short _valueMaxLength = 32;
    readonly ILogger<E>? _logger;

    public E(ILogger<E>? logger = null) : base("agent_secchuaplatform_table", logger)
    {
        _logger = logger;
