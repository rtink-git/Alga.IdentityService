namespace Alga.IdentityService.Core.Entities.Agent.UserAgent;

public class E : Infrastructure.KVA.AdbABase<string?>, IE
{
    readonly short _valueMaxLength = 1024;
    readonly ILogger<E>? _logger;

    public E(ILogger<E>? logger = null) : base("agent_useragent_table", logger)
    {
        _logger = logger;
    ...
    internal bool IsValidateV(string? value)
    {
