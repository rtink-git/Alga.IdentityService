...
// namespace Alga.IdentityService.API.NATS.RefreshSession;
...
//     {
//         // await foreach (var msg in _bus.SubscribeAsync<string>($"{Constants.EnvironmentName}.auth_db_service.session.refresh.request"))
//         //     try
//         //     {
//         //         if (msg.Data == null || msg.ReplyTo == null) continue;

//         //         await _bus.PublishAsync(msg.ReplyTo, new Application.Handlers.SessionRefresh.H(_sessionProvider).Execute(msg.Data));
